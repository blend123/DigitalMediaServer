...
Function LockedListShow
	StrCmp $R1 0 +2 ; Skip the page if clicking Back from the next page.
		Abort
	!insertmacro MUI_HEADER_TEXT `DMS must be closed before installation` `Clicking Next will automatically close it.`
...
Section "Uninstall"
	...
	Delete /REBOOTOK "$INSTDIR\dms.pid"
	Delete /REBOOTOK "$INSTDIR\DMS.conf"
