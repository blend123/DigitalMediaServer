...
public class ViewLevel {
	...
	/**
	 * <code>DEVELOPER</code> is meant for developers where e.g debug
	...
	/**
	 * Returns <code>true</code> if this ViewLevel has a higher or equal
	 * ViewLevel than the ViewLevel passed as argument, <code>false</code>
	 * otherwise.
	 */
	...
	/**
	 * Convert the string passed as argument to a ViewLevel. If the conversion
	...
	/**
	 * Convert an integer passed as argument to a ViewLevel. If the conversion
	 * fails, then this method returns {@link #UNKNOWN}.
	 */
