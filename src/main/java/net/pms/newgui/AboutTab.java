...
public class AboutTab {
	...
	public JComponent build() {
		...
		JLabel lPms3Link = builder.addLabel(dmsLink.getLabel(), cc.xy(2, 1, "center, fill"));
		lPms3Link.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		lPms3Link.addMouseListener(dmsLink);
		...
		final LinkMouseListener mediaInfoLink = new LinkMouseListener("MediaInfo", "https://mediaarea.net");
		...
		JLabel lOpenSubtitlesLink = builder.addLabel(openSubtitlesLink.getLabel(), cc.xy(2, 21, "center, fill"));
		...
		JLabel lCoverArtArchiveLink = builder.addLabel(coverArtArchiveLink.getLabel(), cc.xy(2, 23, "center, fill"));
		...
		JLabel lMusicBrainzLink = builder.addLabel(musicBrainzLink.getLabel(), cc.xy(2, 25, "center, fill"));
